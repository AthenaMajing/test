<template>
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item>
					...
					<el-button type="primary" v-on:click="newaddrole">添加</el-button>
					<el-button type="primary" v-on:click="permissionc">权限分配</el-button>
				</el-form-item>
			</el-form>
		</el-col>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column type="index" width="200" label="序号" sortable>
			</el-table-column>
			<el-table-column prop="rolename" label="角色名称" width="1270">
			</el-table-column>
            ...
            <!--<el-table-column label="操作" width="300">
				<template slot-scope="scope">
					<el-button size="small" @click="newaddrole">新增角色</el-button>
				</template>
			</el-table-column>
            <el-table-column label="操作" width="300">
				<template slot-scope="scope">
					<el-button size="small" @click="permissionc">权限分配</el-button>
				</template>
			</el-table-column>-->
		</el-table>
		...
		<el-dialog title="修改信息" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="120px" :rules="formRules" ref="editForm">
				<el-form-item label="客服姓名" prop="account">
				...
				<el-form-item label="类型" prop="superuser">
					<el-input v-model="editForm.superuser" :disabled="true"> </el-input>
				</el-form-item>
				<el-form-item label="权限" prop="permission">
					<el-select v-model="editForm.permission" name = "permission" placeholder="请选择权限">
						...
						<el-option label="顶级权限" value="3"></el-option>
					</el-select>
				</el-form-item>
			...
			<div slot="footer" class="dialog-footer">
				...
				<el-button size="small" @click="deleteEdit()" style="float:left">删除客服</el-button>
			</div>
		</el-dialog> 
		...
		methods: {
			...
			getUsers() {
				...
				if(this.filters.name){
					var url = "showrole/"+this.filters.name+'/'+ this.page +"/"
				}else{
					var url = "showrole/all/"+ this.page +"/"
				}
			...
			handleEdit: function (index, row) {
				...
				this.editForm = {}
				let token = sessionStorage.token || localStorage.token 
				var url = "/showusers/"+ row.name + "/"+ this.page +"/"
				console.log()
				this.$http.get(url,{
					headers: {
						'Authorization': 'JWT '+ token
				...
				this.$refs.editForm.validate((valid) => {
					if (valid) {
						this.$confirm('确认提交吗？', '提示', {}).then(() => {
							...
							let url = "/addusers/"+ this.editForm.user_id + "/"
